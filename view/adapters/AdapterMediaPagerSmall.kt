...
import com.hooleyapp.organizer.databinding.AdapterMediaPagerSmallBinding
import com.hooleyapp.organizer.view.ui.base.ActivityBase

class AdapterMediaPagerSmall (val mList : ArrayList<GetMediaReportsDetailResponseModel.Media>?): PagerAdapter() {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        val binding : AdapterMediaPagerSmallBinding = DataBindingUtil.inflate(inflater,R.layout.adapter_media_pager_small,container,false)
